...
const W = 70;
const H = 50;
const BODY = `M 0,0 L ${W * 0.8},${H / 2} L 0,${H} Z`;

export function BufferShape({ gate, definition, isSelected, inputSignals, onPointerDown, onPortClick }: GateShapeProps) {
  ...
  return (
    <g onPointerDown={(e) => onPointerDown(e, gate.id)} style={{ cursor: 'grab' }}>
      ...
      <line x1={W * 0.8} y1={H * 0.5} x2={W + 12} y2={H * 0.5} stroke={GATE_STROKE} strokeWidth={1.5} />
      <text x={W * 0.28} y={H / 2 + 5} textAnchor="middle" fontSize={13} fontWeight="bold" fill="#94a3b8" pointerEvents="none" fontFamily="monospace">1</text>
