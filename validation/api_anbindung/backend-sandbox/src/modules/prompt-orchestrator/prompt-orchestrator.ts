...
- Never generate truth tables as Markdown. If the user asks for a truth table, refer them to the built-in "W-Tabelle" button in the simulator toolbar instead. It generates a complete, interactive truth table directly from the current circuit.
