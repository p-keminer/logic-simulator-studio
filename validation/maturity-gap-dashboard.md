...
| ~~P1-8~~ | FSM export projection semantics for STT and timing | **DONE P1-8 2026-03-23**  current scope closed; FSM0-8 (Netzlisten-Minimierung) consciously deferred |
| ~~P1-9~~ | Race panel lifecycle semantics for reset, pruning, and dedupe | **DONE P1-9 2026-03-23**  store-side pruning, manual reset, incident-dedupe, monitor-state helpers, structure-fingerprint pruning all implemented and verified |
| ~~P1-API~~ | API-/Broker-Strang (API1-01 through API1-05) | **DONE 2026-03-24**  Self-Hosted: session/key, chat/reset, staging profile, real provider clients (Anthropic + OpenAI-compatible), H1–H5 hardening live-verified via smoke-verify.mjs; next: API2-01 |
...
| ID | Issue | Criterion |
|---|---|---|
| ~~P2-1~~ | ~~MS_JK_FF HDL export approximates master-slave as negedge-only~~ | **DONE 2026-03-18**  synthesis-approximation comment added to Verilog + VHDL exports |
