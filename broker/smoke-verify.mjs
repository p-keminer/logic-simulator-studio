...
const log_path = process.env.BROKER_SMOKE_LOG_PATH
  ? resolve(process.env.BROKER_SMOKE_LOG_PATH)
  : join(tmpdir(), 'broker-smoke.log');
const log_raw = readFileSync(log_path, 'utf8');
